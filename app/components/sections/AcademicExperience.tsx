    ...
    >
      <div className="mx-auto max-w-[1180px]">
        ...
        >
          ...
          >
            <GraduationCap className="h-4 w-4 text-[#6c63ff]" strokeWidth={1.8} />
          </motion.div>
          ...
          <motion.h2
            ...
            className="text-[2rem] font-bold leading-none tracking-[-0.03em] text-[#0f172a] md:text-[3rem]"
          >
            {t("title")}
          </motion.h2>
          ...
          <motion.p
            ...
            className="mt-3 text-[14px] font-normal text-[#64748b] md:text-[15px]"
          >
            {t("subtitle")}
          </motion.p>
        </motion.div>
                  ...
                  <div className="flex gap-4 md:gap-5">
                    ...
                    <div className="flex-shrink-0">
                      <motion.div
                        ...
                        className="flex h-9 w-9 items-center justify-center rounded-[10px] bg-gradient-to-br from-[#7c4dff] to-[#9333ea] shadow-[0_8px_16px_rgba(124,77,255,0.25)] md:h-10 md:w-10"
                      >
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      <div className="flex flex-col gap-3 md:flex-row md:items-start md:justify-between">
                        <div className="min-w-0">
                          <h3 className="text-[17px] font-semibold leading-tight text-[#5b4ff7] transition-colors duration-300 group-hover:text-[#4f46e5] md:text-[19px]">
                        ...
                        {/* meta */}
                        <div className="flex shrink-0 flex-col gap-1 text-[12.5px] text-[#64748b] md:items-start">
                          <div className="flex items-center gap-1.5">
                            <CalendarDays className="h-[12px] w-[12px] text-[#94a3b8]" strokeWidth={1.8} />
                            <span>{item.period}</span>
                          </div>
                          <div className="flex items-center gap-1.5">
                            <MapPin className="h-[12px] w-[12px] text-[#94a3b8]" strokeWidth={1.8} />
                      ...
                      {/* description */}
                      <p className="mt-4 text-[13.5px] leading-[1.8] text-[#475569] md:text-[14px]">
                        {t(`items.${item.key}.description`)}
                      </p>

                      {/* highlights */}
                      <div className="mt-4">
                        <h5 className="mb-2.5 text-[12.5px] font-semibold uppercase tracking-wide text-[#334155]">
                          {t("highlights")}
                        </h5>
                          ...
                          {(t.raw(`items.${item.key}.highlights`) as string[]).map(
                            (highlight: string, i: number) => (
                              <motion.li
                                ...
                                whileInView="visible"
                                viewport={{ once: true }}
                                className="flex items-start gap-2.5 text-[13px] leading-[1.7] text-[#475569]"
                              >
                                <span className="mt-[9px] h-[4px] w-[4px] shrink-0 rounded-full bg-[#6c63ff]" />
                                <span>{highlight}</span>
                              </motion.li>
                            )
                          )}
