          ...
          <div className="space-y-8 md:space-y-10">
            {academicExperience.map((item) => (
              ...
              >
                ...
                <div className="absolute left-0 top-8 z-10 hidden md:flex h-14 w-14 items-center justify-center rounded-2xl bg-gradient-to-br from-[#7c3aed] to-[#4f46e5] shadow-[0_10px_25px_rgba(124,58,237,0.25)]">
                  <GraduationCap className="h-6 w-6 text-white" />
                </div>
